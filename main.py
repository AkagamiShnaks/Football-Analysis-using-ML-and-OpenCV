...
def main():
    ...
    obj_tracker = ObjectTracker(
        model_path='models/best.pt',    # Object Detection Model Weights Path
    ...
    kp_tracker = KeypointsTracker(
        model_path='models/best_football_field (1).pt', # Keypoints Model Weights Path
    ...
    process_video(processor,                                # Created FootballVideoProcessor object
                  video_source='input_videos/test.mp4', # Video source (in this case video file path)
                  output_video='output_videos/testx1.mp4',    # Output video path (Optional)
